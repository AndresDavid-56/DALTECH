...
<div class="container">
        ...
        <div class="card">
            ...
            <div class="row credit">
                <div class="left">
                    ...
                    <div class="radio"></div>
                    <label for="cd">Tarjeta de Débito / Crédito </label>
                </div>
                <div class="right">
    ...
    <div class="button" href="welcome">
        <button type="submit"><i class="ion-locked"></i> Confirmar y Pagar</button>
    </div>
</div>